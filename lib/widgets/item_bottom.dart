...
class ItemBottom extends StatefulWidget {
  ...
  const ItemBottom(this.itemModel, {super.key});

  @override
  State<ItemBottom> createState() => _ItemBottomState();
}

class _ItemBottomState extends State<ItemBottom> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    selectProvider.addListener(() {
      if(selectProvider.selectedItemPosition == SelectedItemPosition.bottom){
      ...
      child: SlideTransition(
        ...
        child: InkWell(
          onTap: () {
            if(isTouchable) {
              isTouchable = false;
              selectProvider.setSelectedItem(SelectedItemPosition.bottom, widget.itemModel);
            }
          },
          child: Container(
            color: Colors.black,
