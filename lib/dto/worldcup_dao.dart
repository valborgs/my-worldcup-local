...
class WorldCupDao{
  ...
  Future<void> syncSampleWorldCup() async {
    ...
    List<WorldCupModel> newList = [
      WorldCupModel(-1, "여자 아이돌 월드컵", "최고의 여자 아이돌", DateTime(0), "$rootDirectory/female/aespa_carina.jpg", 16),
      WorldCupModel(-2, "남자 아이돌 월드컵", "최고의 남자 아이돌", DateTime(0), "$rootDirectory/male/astro_cha.jpg", 16)
    ];
    
    List<WorldCupItemModel> itemList1 = [
      WorldCupItemModel(1, "$rootDirectory/female/aespa_carina.jpg", "에스파 카리나", -1),
      WorldCupItemModel(2, "$rootDirectory/female/hearts2_ian.jpg", "하츠투하츠 이안", -1),
      ...
      WorldCupItemModel(5, "$rootDirectory/female/babymon_ahyun.jpg", "베이비몬스터 아현", -1),
      WorldCupItemModel(6, "$rootDirectory/female/promise_song.jpg", "프로미스나인 송하영", -1),
      WorldCupItemModel(7, "$rootDirectory/female/ilit_wonhee.jpg", "아일릿 원희", -1),
      WorldCupItemModel(8, "$rootDirectory/female/newjeans_haerin.jpg", "뉴진스 해린", -1),
      WorldCupItemModel(9, "$rootDirectory/female/itzy_yuna.jpg", "있지 유나", -1),
      WorldCupItemModel(10, "$rootDirectory/female/rescene_won.jpg", "리센느 원이", -1),
      WorldCupItemModel(11, "$rootDirectory/female/meovv_anna.jpg", "미야오 안나", -1),
      WorldCupItemModel(12, "$rootDirectory/female/triples_chaewon.jpg", "트리플에스 김채원", -1),
      WorldCupItemModel(13, "$rootDirectory/female/chu.jpg", "츄", -1),
      WorldCupItemModel(14, "$rootDirectory/female/izone_hyewon.jpg", "강혜원", -1),
      WorldCupItemModel(15, "$rootDirectory/female/idle_miyeon.jpg", "아이들 미연", -1),
      WorldCupItemModel(16, "$rootDirectory/female/lesserafim_kimchaewon.jpg", "르세라핌 김채원", -1),
    ];

    List<WorldCupItemModel> itemList2 = [
      WorldCupItemModel(1, "$rootDirectory/male/park_ji_hun.jpg", "박지훈", -2),
      WorldCupItemModel(2, "$rootDirectory/male/cortis_gunho.jpg", "코르티스 건호", -2),
      WorldCupItemModel(3, "$rootDirectory/male/nct127_jaehyun.jpg", "NCT 127 재현", -2),
      WorldCupItemModel(4, "$rootDirectory/male/tws_dohun.jpg", "투어스 도훈", -2),
      WorldCupItemModel(5, "$rootDirectory/male/and2ble_yujin.jpg", "앤더블 한유진", -2),
      ...
      WorldCupItemModel(9, "$rootDirectory/male/theboyz_juyeon.jpg", "더보이즈 주연", -2),
      WorldCupItemModel(10, "$rootDirectory/male/riize_wonbin.jpg", "라이즈 원빈", -2),
      WorldCupItemModel(11, "$rootDirectory/male/nctwish_riku.jpg", "NCT WISH 리쿠", -2),
      WorldCupItemModel(12, "$rootDirectory/male/btob_yuk.jpg", "비투비 육성재", -2),
      WorldCupItemModel(13, "$rootDirectory/male/enhyphen_sunwoo.jpg", "엔하이픈 선우", -2),
      WorldCupItemModel(14, "$rootDirectory/male/txt_taehyun.jpg", "TXT 태현", -2),
      WorldCupItemModel(15, "$rootDirectory/male/astro_cha.jpg", "아스트로 차은우", -2),
      WorldCupItemModel(16, "$rootDirectory/male/got7_jinyoung.jpg", "갓세븐 진영", -2),
    ];
