...
void main() {
  ...
  test('상태는 번역문을 저장하지 않아 같은 상태도 현재 언어로 표시할 수 있다', () {
    ...
    expect(_PreviewLocalization().message(state), 'Preview sending');
  });
...
class _PreviewLocalization extends AppLocalizationsKo {
  @override
  String get nearbySending => 'Preview sending';
}
